...
export function BootScreen() {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 bg-bc-black flex flex-col items-center px-6 transition-opacity duration-700 ${
        done ? 'opacity-0 pointer-events-none' : 'opacity-100'
      }`}
    >
      <div className="shrink-0 flex flex-col items-center gap-4 pt-8 pb-2">
      ...
      <div className="w-full max-w-xl shrink-0 pb-8">
