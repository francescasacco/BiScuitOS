...
export function TaskBoardWidget() {
  ...
  return (
    <div className="border border-bc-border/40 rounded-lg bg-bc-dark/30 px-3 py-2.5">
      <p className="font-mono text-[10px] text-bc-amber uppercase tracking-widest mb-2">Cose da fare</p>
      <div className="space-y-1">
        {priorities.map((p, i) => (
          <div key={i} className="flex items-start gap-2 py-0.5">
            <Diamond size={8} strokeWidth={1.5} className="text-bc-border shrink-0 mt-1" />
