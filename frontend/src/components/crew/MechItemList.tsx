  ...
  return (
    <div className="space-y-2">
        ...
        <div className="space-y-1">
          {items.map((item, i) => (
            <div key={i} className="flex items-center gap-2 px-2.5 py-1.5 bg-bc-dark border border-bc-border rounded-md group">
              ...
              <button type="button" className="font-mono text-xs text-bc-muted/0 group-hover:text-bc-muted hover:!text-bc-red transition-colors shrink-0"
      ...
      <div className="flex gap-2">
        ...
        />
        <button type="button" className="font-mono text-xs text-bc-blue border border-bc-blue/40 px-3 hover:border-bc-blue hover:bg-bc-blue/10 transition-all shrink-0 flex items-center" onClick={add}>
